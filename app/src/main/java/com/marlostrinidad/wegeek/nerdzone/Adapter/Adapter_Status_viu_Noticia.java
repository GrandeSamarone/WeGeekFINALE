...
public class Adapter_Status_viu_Noticia extends RecyclerView.Adapter<Adapter_Status_viu_Noticia.MyViewHolder> {
    private List<Status> list_Status;
    private Context context;
    private String identificadorUsuario;
    private FirebaseFirestore db;
    private Dialog dialog;
    public Adapter_Status_viu_Noticia(List<Status> list,Context context){
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        db.collection("Status_banca_noticia")
                            ...
                            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                if (task.isSuccessful()) {
                                    for (DocumentSnapshot document : task.getResult()) {
                                        ...
                                        db.collection("Status_banca_noticia").document(status.getId_loja())
    ...
    private void limpar(String id_loja, final String idStatus){
        ...
        db.collection("Banca_Noticia").whereEqualTo("id",id_loja)
                .get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    for (DocumentSnapshot document : task.getResult()) {
                        ...
                        db.collection("Banca_Noticia").document(document.getId())
